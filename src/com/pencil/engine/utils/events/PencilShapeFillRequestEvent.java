...
public class PencilShapeFillRequestEvent extends Event implements PencilEvent {
    ...
    public PencilShapeFillRequestEvent(Player player, ShapeUtils.ShapeType type, Selection selection) {
        this.player = player;
    }
    ...
    public PencilAction getAction() {
        return new PencilNonUndoableAction(PencilAction.ActionType.OPERATION);
    }
